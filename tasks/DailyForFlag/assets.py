...
class DailyForFlagAssets: 
	...
	# Image Rule Assets
	# description 
	I_DONATE = RuleImage(roi_front=(270,494,27,26), roi_back=(243,465,80,87), threshold=0.8, method="Template matching", file="./tasks/DailyForFlag/donatejade/donatejade_donate.png")
	# description 
	I_ADD = RuleImage(roi_front=(780,276,60,55), roi_back=(763,251,100,100), threshold=0.8, method="Template matching", file="./tasks/DailyForFlag/donatejade/donatejade_add.png")
	# description 
	I_LIMIT = RuleImage(roi_front=(826,349,47,77), roi_back=(817,342,69,100), threshold=0.8, method="Template matching", file="./tasks/DailyForFlag/donatejade/donatejade_limit.png")
	# description 
	I_CLICK_DONATE = RuleImage(roi_front=(577,524,133,48), roi_back=(553,501,178,92), threshold=0.8, method="Template matching", file="./tasks/DailyForFlag/donatejade/donatejade_click_donate.png")
	# description 
	I_AWARD = RuleImage(roi_front=(476,178,327,100), roi_back=(438,160,399,133), threshold=0.8, method="Template matching", file="./tasks/DailyForFlag/donatejade/donatejade_award.png")
