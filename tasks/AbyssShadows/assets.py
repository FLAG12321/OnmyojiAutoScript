...
class AbyssShadowsAssets: 
	...
	# Image Rule Assets
	# 阴阳竂->神社 
	I_RYOU_SHENSHE = RuleImage(roi_front=(873,674,52,29), roi_back=(854,645,88,72), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_ryou_shenshe.png")
	# 神社->狭间暗域 
	...
	# 狭间暗域 
	I_ABYSS_SHADOWS = RuleImage(roi_front=(714,477,107,38), roi_back=(678,435,184,122), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_abyss_shadows.png")
	# 开启狭间暗域 
