...
class OrochiAssets: 
	...
	# description 
	I_OROCHI_LOCK = RuleImage(roi_front=(700,660,30,22), roi_back=(613,643,293,73), threshold=0.7, method="Template matching", file="./tasks/Orochi/o/orochi_lock.png")
	# description 
	I_OROCHI_UNLOCK = RuleImage(roi_front=(701,656,28,25), roi_back=(628,639,178,73), threshold=0.7, method="Template matching", file="./tasks/Orochi/o/orochi_unlock.png")
	# 点击挑战 
