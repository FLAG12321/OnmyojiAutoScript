...
class GeneralRoomAssets: 
	...
	# description 
	I_CREATE_ENSURE = RuleImage(roi_front=(840,573,74,37), roi_back=(785,543,187,100), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralRoom/gr/create_ensure.png")
	# 勾选不公开的图 
