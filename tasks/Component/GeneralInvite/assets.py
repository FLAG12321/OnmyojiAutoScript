...
class GeneralInviteAssets: 
	...
	# 点击邀请 
	I_INVITE_ENSURE = RuleImage(roi_front=(738,554,72,39), roi_back=(710,544,132,60), threshold=0.7, method="Template matching", file="./tasks/Component/GeneralInvite/gi/invite_ensure.png")
	# 判断是否点中好友了 
	...
	# description 
	I_I_REJECT_4 = RuleImage(roi_front=(26,225,41,48), roi_back=(11,150,199,300), threshold=0.7, method="Template matching", file="./tasks/Component/GeneralInvite/gi/i_reject_4.png")
