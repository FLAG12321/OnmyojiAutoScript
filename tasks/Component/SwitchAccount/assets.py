...
class SwitchAccountAssets: 
	...
	# 取消集结 
	I_CANCEL_TOINVITE = RuleImage(roi_front=(504,430,63,41), roi_back=(474,424,118,52), threshold=0.7, method="Template matching", file="./tasks/Component/SwitchAccount/res/res_cancel_toinvite.png")
	...
	# Swipe Rule Assets
	# 登录界面 服务器列表的手指向左滑动 
	S_SA_SVR_SWIPE_LEFT = RuleSwipe(roi_front=(595,576,57,22), roi_back=(587,287,54,26), mode="default", name="sa_svr_swipe_left")
	# 登录界面 账号列表的手指向上滑动 
