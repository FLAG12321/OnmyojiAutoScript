...
# 真人多点簇的峰值在 4 点、最长 11 点。
MULTI_CLICK_SIZES = (1, 2, 3, 4, 5, 6, 8, 9, 10, 11)     # 一次手势的总点击数取值
MULTI_CLICK_WEIGHTS = (258, 18, 35, 90, 33, 7, 6, 2, 1, 1)  # 对应权重＝真人簇长直方图
MULTI_CLICK_GAP_S = (0.15, 0.22)     # 追加击与前一击的间隔（秒）：真人簇内间隔
