...
class DokanAssets: 
	...
	# 管理放弃道馆over 
	I_QUIT_DOKAN_OVER = RuleImage(roi_front=(1056,211,55,28), roi_back=(1043,190,104,66), threshold=0.8, method="Template matching", file="./tasks/Dokan/res/Screenshots_quit_dokan_over.png")
	# 寮友同意放弃突破 
	...
	# Ocr Rule Assets
	# 道馆开启状态 
	O_DOKAN_STATUS = RuleOcr(roi=(492,628,222,44), area=(0,0,100,100), mode="Full", method="Default", keyword="", name="dokan_status")
	# 选择寮1 
	...
	# 道馆地图里找文字：万 
	O_DOKAN_MAP = RuleOcr(roi=(270,130,740,460), area=(0,0,100,100), mode="Full", method="Default", keyword="万", name="dokan_map")
	# 道馆里找文字：后开战 
	...
	# 道馆里找文字：后关闭 
	O_DOKAN_SUCCEEDED = RuleOcr(roi=(655,76,49,28), area=(0,0,100,100), mode="Full", method="Default", keyword="关闭", name="dokan_succeeded")
	# 查找道馆时,右侧边栏中的赏金 
	...
	# Swipe Rule Assets
	# 道馆选择界面 右侧侧边栏 手指向上滑动 
	S_DOKAN_LIST_UP = RuleSwipe(roi_front=(1099,493,30,9), roi_back=(1096,126,30,9), mode="default", name="dokan_list_up")
