...
class MysteryShopAssets: 
	...
	# description 
	I_MS_TAIKO_3 = RuleImage(roi_front=(176,353,140,104), roi_back=(144,50,866,494), threshold=0.85, method="Template matching", file="./tasks/MysteryShop/ms/ms_ms_taiko_3.png")
	# description 
	I_MS_TAIKO_4 = RuleImage(roi_front=(399,380,146,101), roi_back=(156,81,874,473), threshold=0.85, method="Template matching", file="./tasks/MysteryShop/ms/ms_taiko_4.png")
	# description 
	...
	# description 
	I_MS_TAIKO_OFF_3 = RuleImage(roi_front=(397,118,151,102), roi_back=(123,50,920,558), threshold=0.85, method="Template matching", file="./tasks/MysteryShop/ms/ms_taiko_off_3.png")
	# description 
	I_MS_TAIKO_OFF_4 = RuleImage(roi_front=(621,384,151,98), roi_back=(121,53,932,566), threshold=0.85, method="Template matching", file="./tasks/MysteryShop/ms/ms_taiko_off_4.png")
