...
class ConfigManual:
    ...
    SCHEDULER_PRIORITY = """
        ...
        > AreaBoss > GoldYoukai > ExperienceYoukai > Nian > Tako > AutoCheckinBigGod > MultiAccExp > MasterDisciple > RealmRaid > RyouToppa > DailyTrifles > Exploration >  DailyForFlag>FindJade
